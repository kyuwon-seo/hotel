...
<div>
	...
	<!-- method="post" -->
		<form action="<%=request.getContextPath()%>/roomAdd" method="post">
			<!-- 호텔 지점<input name="hotel_name" placeholder="ex)SK호텔서울" style="border: solid;border-color: gray;"/> <br />
			<br /> 방 번호<input type="number" name="room_no" placeholder="ex)101" style="border: solid;border-color: gray;"/> <br />
			<br /> 방 타입<input type="text" name="room_type" placeholder="ex)standard" style="border: solid;border-color: gray;"/><br />
			<br /> 침대 타입<input type="text" name="room_bedType" placeholder="ex)double" style="border: solid;border-color: gray;"/><br />
			<br /> 방 크기<input type="number" name="room_size" placeholder="ex)50" style="border: solid;border-color: gray;"/> <br />
			<br /> 뷰 타입<input type="text" name="room_view" placeholder="ex)River" style="border: solid;border-color: gray;"/><br />
			<br /> 요금<input type="number" name="room_fare" placeholder="ex)50000" style="border: solid;border-color: gray;"/><br />
			<br /> -->
			호텔 지점<input name="hotel_name" placeholder="ex)SK호텔서울" style="border: solid;border-color: gray;"/> <br />
			<br /> 방 번호<input name="room_no" placeholder="ex)101" style="border: solid;border-color: gray;"/> <br />
			<br /> 방 타입<input name="room_type" placeholder="ex)standard" style="border: solid;border-color: gray;"/><br />
			<br /> 침대 타입<input name="room_bedType" placeholder="ex)double" style="border: solid;border-color: gray;"/><br />
			<br /> 방 크기<input name="room_size" placeholder="ex)50" style="border: solid;border-color: gray;"/> <br />
			<br /> 뷰 타입<input name="room_view" placeholder="ex)River" style="border: solid;border-color: gray;"/><br />
			<br /> 요금<input name="room_fare" placeholder="ex)50000" style="border: solid;border-color: gray;"/><br />
			<br />
			<input type="submit" value="방 추가"></input>
		</form>
				</div>
	</div>
	<footer
