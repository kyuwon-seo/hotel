...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/etc.clientlibs/roomlist.css" type="text/css">	
            ...
            <ul>
			 ...
			 <div>
				<div id="container" class="ly-container">
					<div align="center">
							<% List<RoomVO> roomList = (List<RoomVO>)request.getSession().getAttribute("roomList"); %>
							<table>
							<thead>
								<tr>
									<th>&nbsp;&nbsp;&nbsp;</th>
							...
							for(int i=0 ; i<roomList.size() ; i++){
								...
								<!--스텐다드 트윈, 디럭스 트윈, 디럭스 더블, 스위트  -->
								    <%if(roomList.get(i).getRoom_type().equals("standard twin")) {
								    	%>
								   ...
								   <%	
								    ...
								    %> 
								    <%if(roomList.get(i).getRoom_type().equals("deluxe twin")) {
								    	%>
								   ...
								   <%	
								    ...
								    %> 
								    <%if(roomList.get(i).getRoom_type().equals("deluxe double")) {
								    	%>
								   ...
								   <%	
								    ...
								    %> 
								    <%if(roomList.get(i).getRoom_type().equals("suite")) {
								    	%>
								   ...
								   <%	
								    ...
								    %> 
									<td>&nbsp;&nbsp;<%=roomList.get(i).getRoom_no() %>&nbsp;&nbsp;</td>
									
									<td>&nbsp;<%=roomList.get(i).getRoom_type()%>&nbsp;&nbsp;</td>
									<td>&nbsp;&nbsp;<%=roomList.get(i).getRoom_bedType() %>&nbsp;&nbsp;</td>
									
									<td>&nbsp;&nbsp;<%=roomList.get(i).getRoom_size()%>&nbsp;&nbsp;</td>
									<td>&nbsp;&nbsp;<%=roomList.get(i).getRoom_view()%>&nbsp;&nbsp;</td>
							...
							if(searchKeyword.equals("SK호텔부산")){
								for(int i=0 ; i<roomList.size() ; i++){
									...
									<tr>
									<!--스텐다드 트윈, 디럭스 트윈, 디럭스 더블, 스위트  -->
									    <%if(roomList.get(i).getRoom_type().equals("standard")) {
									    	%>
										<td><img style="width: 300px;height: 200px;" src="${pageContext.request.contextPath}/resources/etc.clientlibs/lottehotel/standardTwin.jpg"></img></td>
									   ...
									   <%	
									    ...
									    %> 
									    <%if(roomList.get(i).getRoom_type().equals("deluxe")) {
									    	%>
