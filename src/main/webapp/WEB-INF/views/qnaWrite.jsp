...
<!-- sadfsadf -->
   ...
   <div class="row">
    ...
    <!-- <div class="col-md-8"> -->
        ...
        <form action="<%=request.getContextPath()%>/qnaBoard" name="myform" onsubmit="return send();" method="post">
          ...
          <div id="write">
      		...
      		<a href="<%=request.getContextPath()%>/qnaBoard" class="btn btn-default">목록으로</a>
    	  </div>
